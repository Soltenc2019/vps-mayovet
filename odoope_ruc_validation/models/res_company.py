...
class ResCompany(models.Model):
    ...
    l10n_pe_api_dni_connection = fields.Selection([
        ...
        # ('free_api','Free Api'),
        ('soltecn_api','Soltecn Api'),
        ('soltecn_api_2','Soltecn Api 2')
    ], string='Api DNI Connection', default='soltecn_api_2')
    ...
    l10n_pe_api_ruc_connection = fields.Selection([
        ...
        ('soltecn_api','Soltecn Api'),
        ('soltecn_api_2','Soltecn Api 2')
    ], string='Api RUC Connection', default='soltecn_api_2')
    ...
    # domain_company = fields.Char(string="Dominio")
